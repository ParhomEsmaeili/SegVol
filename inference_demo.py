...
def set_parse():
    ...
    parser.add_argument("--resume", type = str, default = './ckpt/SegVol_v1.pth')
    ...
    ### demo
    parser.add_argument('--demo_config', type=str, default='./config/config_demo.json')
...
def main(args):
    ...
    args.use_text_prompt = False #True
    args.use_box_prompt = True
    args.use_point_prompt = False #True #False
    args.visualize = True
